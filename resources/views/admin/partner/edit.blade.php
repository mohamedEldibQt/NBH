        ...
        <div class="content-wrapper">
            ...
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2">
                    <h3 class="content-header-title"> {{trans('words.edit_partner')}}</h3>
                            ...
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        ...
                                        <form class="form" action="{{route('partner_update',['id'=>$partner->id])}}" method="post"  enctype="multipart/form-data">
                                            @csrf
                                            <div class="form-body">
                                                <h4 class="form-section"><i class="ft-user"></i>  {{trans('words.partner_info')}}</h4>
                                                <div class="row">
                                                    <div class="col-md-3">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" id="projectinput1" class="form-control" placeholder="{{trans('words.small_description')}}"
                                                                   name="partner_s_description" value="{{$partner->partner_s_description}}">                            
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea id="issueinput8" rows="5" class="form-control" name="partner_description"
                                                                      data-toggle="tooltip" data-trigger="hover" data-placement="top"
                                                                      data-original-title="" title="" >{{$partner->partner_description}}
                                                            </textarea>
                                                        </div>
                                                    </div>
                                                </div>
