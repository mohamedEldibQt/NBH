                ...
                <div class="content-header-right col-md-6 col-12">
                    <div class="btn-group float-md-right" >
                        ...
                        <div class="heading-elements">
                            <a href="{{ route('branchFuture_create') }}">
                                    ...
                                    <div class="card-body card-dashboard">
                                        <table class="table table-striped table-bordered file-export"  >
                                            ...
                                            <tr>
                                                ...
                                                <th>action {{trans('words.action')}}</th>
                                            </tr>
                                            </thead>
                                            <tbody>

                                            @foreach($branchFuture as $item)
                                                <tr>
                                                    <td>{{$item->id}}</td>
                                                    <td>{{$item->branch_future_name}}</td>
                                                    <td>{{$item->branch_future_description}}</td>
                                                    <td class="text-center">
                                                        <span class="avatar  ">
                                                          <img  src="{{URL::asset($item->branch_future_img)}}" alt="{{$item->branch_future_img}}"
                                                    ...
                                                    <td>
                                                        <span class="dropdown">
                                                          ...
                                                          <span aria-labelledby="btnSearchDrop2" class="dropdown-menu mt-1 dropdown-menu-right">
                                                            ...
                                                            <a href="{{ route('branchFuture_edit',['id'=>$item->id]) }}" class="dropdown-item">
                                                                <i class="ft-edit-2"></i>  {{trans('words.edit')}}
                                                            </a>

                                                          <form action="{{ route('branchFuture_softdelete',['id'=>$item->id]) }}" method="get">
                                                              @csrf
                                                            ...
                                                            <a href="{{ route('branchFuture_trashed') }}" class="dropdown-item">
