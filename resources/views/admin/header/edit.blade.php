        ...
        <div class="content-wrapper">
            ...
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2">
                    <h3 class="content-header-title">  {{trans('words.edit_header')}}</h3>
                            ...
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        ...
                                        <form class="form" action="{{route('headers_update',['id'=>$headers->id])}}" method="post"  enctype="multipart/form-data">
                                            @csrf

                                            <div class="form-body">
                                                <h4 class="form-section"><i class="ft-user"></i> {{trans('words.header_info')}}</h4>
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" id="projectinput1" class="form-control" placeholder="{{trans('words.title')}}"
                                                                   name="title" value="{{$headers->title}}">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" id="projectinput2" class="form-control" placeholder="{{trans('words.sub_title')}}"
                                                                   name="sub_title"  value="{{$headers->sub_title}}">
                                                        </div>
                                                    </div>
                                                </div>
