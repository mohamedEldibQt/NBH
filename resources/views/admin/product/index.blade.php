        ...
        <div class="content-wrapper">
            ...
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2">
                    <h3 class="content-header-title"> {{trans('words.product_datatable')}}</h3>
                    ...
                    <div class="btn-group float-md-right" >
                        ...
                        <div class="heading-elements">
                            <a href="{{ route('product_create') }}">
                                <button class="btn btn-primary btn-sm"><i class="ft-plus white"></i>  {{trans('words.create_product')}} </button></a>
                            <span class="dropdown">
                                    ...
                                    <div class="card-body card-dashboard">
                                        <table class="table table-striped table-bordered file-export"  >
                                            ...
                                            <tr>
                                                ...
                                                <th>  {{trans('words.product_name')}}</th>
                                                <th>  {{trans('words.product_img')}}</th>
                                            ...
                                            @foreach($products as $item)
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <span class="avatar  ">
                                                          <img src="{{URL::asset($item->product_img)}}" alt="{{$item->product_img}}"
                                                    ...
                                                    <td>
                                                        <span class="dropdown">
                                                          ...
                                                          <span aria-labelledby="btnSearchDrop2" class="dropdown-menu mt-1 dropdown-menu-right">
                                                            ...
                                                            <a href="{{ route('product_edit',['id'=>$item->id]) }}" class="dropdown-item">
                                                                <i class="ft-edit-2"></i> {{trans('words.edit')}}
                                                            </a>

                                                          <form action="{{ route('product_softdelete',['id'=>$item->id]) }}" method="get">
                                                              @csrf
                                                            ...
                                                            <a href="{{ route('product_trashed') }}" class="dropdown-item">
