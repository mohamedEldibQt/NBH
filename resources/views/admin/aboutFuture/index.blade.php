        ...
        <div class="content-wrapper">
            ...
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2">
                    <h3 class="content-header-title">{{trans('words.future_datatable')}}</h3>
                ...
                <div class="content-header-right col-md-6 col-12">
                    <div class="btn-group float-md-right" >
                        ...
                        <div class="heading-elements">
                            <a href="{{ route('aboutFuture_create') }}">
                                <button class="btn btn-primary btn-sm"><i class="ft-plus white"></i>{{trans('words.create_future')}}</button></a>
                            <span class="dropdown">
                                    ...
                                    <div class="card-body card-dashboard">
                                        <table class="table table-striped table-bordered file-export"  >
                                            ...
                                            <tr>
                                                ...
                                                <th> {{trans('words.future_name')}}</th>
                                                <th> {{trans('words.future_description')}}</th>
                                                <th> {{trans('words.future_img')}}</th>
                                            ...
                                            @foreach($aboutFuture as $item)
                                                <tr>
                                                    <td>{{$item->id}}</td>

                                                    <td>{{$item->future_name}}</td>
                                                    <td>{{$item->future_description}}</td>
                                                    <td class="text-center">
                                                        <span class="avatar  ">
                                                          <img src="{{URL::asset($item->future_img)}}" alt="{{$item->future_img}}"
                                                    ...
                                                    <td>
                                                        <span class="dropdown">
                                                          ...
                                                          <span aria-labelledby="btnSearchDrop2" class="dropdown-menu mt-1 dropdown-menu-right">
                                                            ...
                                                            <a href="{{ route('aboutFuture_edit',['id'=>$item->id]) }}" class="dropdown-item">
                                                                <i class="ft-edit-2"></i>  {{trans('words.edit')}}
                                                            </a>
                                                          <form action="{{ route('aboutFuture_softdelete',['id'=>$item->id]) }}" method="get">
                                                              @csrf
                                                            <button type="submit" class="dropdown-item">
                                                                 <i class="ft-trash"></i> {{trans('words.delete')}}
                                                            </button>
                                                          </form>
                                                             <a href="{{ route('aboutFuture_trashed') }}" class="dropdown-item">
