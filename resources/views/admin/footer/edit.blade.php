        ...
        <div class="content-wrapper">
            ...
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2">
                    <h3 class="content-header-title">  {{trans('words.edit_footer')}}</h3>
                            ...
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        ...
                                        <form class="form" action="{{route('footer_update',['id'=>$footer->id])}}" method="post"  enctype="multipart/form-data">
                                            @csrf
                                            <div class="form-body">
                                                <h4 class="form-section"><i class="ft-user"></i>{{trans('words.footer_info')}}</h4>
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="email" id="projectinput1" class="form-control" placeholder="{{trans('words.contact_email')}}"
                                                                   name="contact_email" value="{{$footer->contact_email}}">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" id="projectinput1" class="form-control" placeholder="{{trans('words.location')}}"
                                                                   name="location"  value="{{$footer->location}}">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" id="projectinput1" class="form-control" placeholder="{{trans('words.phone_num')}}"
                                                                   name="phone_num"  value="{{$footer->phone_num}}">
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea id="issueinput8" rows="5" class="form-control" name="footer_description" placeholder="{{trans('words.footer_description')}}"
                                                                      ...
                                                                      data-original-title="" title="" style="height: 115px;"> value="{{$footer->footer_description}}"</textarea>
                                                        </div>
                                                    </div>
                                                </div>
