                    ...
                    <div class="btn-group float-md-right" >
                        ...
                        <div class="heading-elements">
                            <a href="{{ route('branch_create') }}">
                                <button class="btn btn-primary btn-sm"><i class="ft-plus white"></i>{{trans('words.create_branch')}} </button></a>
                            <span class="dropdown">
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Trashed Branch</h4>
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body card-dashboard">
                                        <table class="table table-striped table-bordered file-export"  >
                                            ...
                                            <tr>
                                                <th>#</th>
                                                <th> {{trans('words.branch_name')}}</th>
                                                <th> {{trans('words.branch_description')}}</th>
                                                <th> {{trans('words.branch_img')}}</th>
                                            ...
                                            @foreach($branch as $item)
                                                <tr>
                                                    ...
                                                    <td>{{$item->branch_description}}</td>
                                                    <td class="text-center">
                                                        <span class="avatar  ">
                                                          <img src="{{URL::asset($item->branch_img)}}" alt="{{$item->branch_img}}"
                                                    ...
                                                    <td>
                                                        <span class="dropdown">
                                                          ...
                                                          <span aria-labelledby="btnSearchDrop2" class="dropdown-menu mt-1 dropdown-menu-right">
                                                            ...
                                                            <a href="{{ route('branch_restore',['id'=>$item->id]) }}" class="dropdown-item">
                                                                <i class="ft-restore-2"></i>  restore {{trans('words.restore')}}
                                                            </a>

                                                          <form action="{{ route('branch_delete',['id'=>$item->id]) }}" method="get">
                                                              @csrf
