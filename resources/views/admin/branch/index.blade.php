        ...
        <div class="content-wrapper">
            ...
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2">
                    <h3 class="content-header-title"> {{trans('words.branch_dataTables')}}</h3>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{$item->branch_description}}</td>
                                                     <td>
                                                       ...
                                                       @foreach($item->images as $branch_img) 
                                                            <img src="{{asset('images/'.$branch_img->img)}}" alt="" style="height: 70px;">
                                                       @endforeach
                                                    ...
                                                    <td>
                                                        <span class="dropdown">
                                                          ...
                                                          <span aria-labelledby="btnSearchDrop2" class="dropdown-menu mt-1 dropdown-menu-right">
                                                            ...
                                                            <a href="{{ route('branch_edit',['id'=>$item->id]) }}" class="dropdown-item">
                                                                <i class="ft-edit-2"></i>   {{trans('words.edit')}}
                                                            </a>

                                                          <form action="{{ route('branch_softdelete',['id'=>$item->id]) }}" method="get">
                                                              @csrf
                                                            ...
                                                            <a href="{{ route('branch_trashed') }}" class="dropdown-item">
