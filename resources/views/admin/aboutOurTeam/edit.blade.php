        ...
        <div class="content-wrapper">
            ...
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2">
                    <h3 class="content-header-title">{{trans('words.edit_about_team')}}</h3>
                            ...
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        ...
                                        <form class="form" action="{{route('aboutOurTeam_update',['id'=>$aboutOurTeam->id])}}" method="post"  enctype="multipart/form-data">
                                            @csrf
                                            <div class="form-body">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" id="projectinput1" class="form-control" placeholder="{{trans('words.team_name')}}"
                                                                   name="team_name" value="{{$aboutOurTeam->team_name}}">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" id="projectinput1" class="form-control" placeholder="{{trans('words.team_position')}}"
                                                                   name="team_position" value="{{$aboutOurTeam->team_position}}">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" id="projectinput1" class="form-control" placeholder="{{trans('words.team_description')}}"
                                                                   name="team_description" value="{{$aboutOurTeam->team_description}}">
                                                        </div>
                                                    </div>
                                                </div>
