        ...
        <div class="content-wrapper">
            ...
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2">
                    <h3 class="content-header-title"> {{trans('words.contactUs_datatable')}}</h3>
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{route('contact_trashed')}}">{{trans('words.contact_trashed')}} </a>
                                </li>
                            </ol>
                        </div>
                    </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <span class="dropdown">
                                                          ...
                                                          <form action="{{ route('contact_softdelete',['id'=>$contact->id]) }}" method="get">
                                                              @csrf
                                                            <button type="submit" class="dropdown-item">
                                                                 <i class="ft-trash"></i> {{trans('words.delete')}}
                                                            </button>
                                                          </form>
                                                             <a href="{{ route('contact_trashed') }}" class="dropdown-item">
