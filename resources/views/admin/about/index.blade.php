        ...
        <div class="content-wrapper">
            ...
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2">
                    <h3 class="content-header-title"> {{trans('words.about_datatables')}}</h3>
                    ...
                    <div class="btn-group float-md-right" >
                        ...
                        <div class="heading-elements">
                            <a href="{{ route('about_create') }}">
                                <button class="btn btn-primary btn-sm"><i class="ft-plus white"></i>  {{trans('words.create_about')}}</button></a>
                            <span class="dropdown">
                                    ...
                                    <div class="card-body card-dashboard">
                                        <table class="table table-striped table-bordered file-export"  >
                                            ...
                                            <tr>
                                                ...
                                                <th>{{trans('words.about_img')}}</th>

                                                <th> {{trans('words.mission')}}</th>
                                                <th> {{trans('words.vision')}}</th>
                                                <th> {{trans('words.our_value')}}</th>
                                            ...
                                            @foreach($about as $item)
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <span class="avatar  ">
                                                          <img src="{{URL::asset($item->about_img)}}" alt="{{$item->about_img}}"
                                                               data-toggle="tooltip" data-placement="right" title="image  ">
                                                        </span>
                                                    </td>
                                                    <td>{{$item->mission}}</td>
                                                    <td>{{$item->vision}}</td>
                                                    <td>{{$item->our_value}}</td>
                                                    ...
                                                    <td>
                                                        <span class="dropdown">
                                                          ...
                                                          <span aria-labelledby="btnSearchDrop2" class="dropdown-menu mt-1 dropdown-menu-right">
                                                            ...
                                                            <a href="{{ route('about_edit',['id'=>$item->id]) }}" class="dropdown-item">
                                                                <i class="ft-edit-2"></i>  {{trans('words.edit')}}
                                                            </a>
                                                          <form action="{{ route('about_softdelete',['id'=>$item->id]) }}" method="get">
                                                              @csrf
                                                            <button type="submit" class="dropdown-item">
                                                                 <i class="ft-trash"></i>   {{trans('words.delete')}}
                                                            </button>
                                                          </form>
                                                             <a href="{{ route('about_trashed') }}" class="dropdown-item">
